...
\usepackage[papersize={215mm,297mm},twoside,bindingoffset=0.5cm,hmargin={2cm,2cm},
		vmargin={2cm,2cm},footskip=1.1cm,driver=dvipdfm]{geometry}
...
\date{~}
\hyphenation{bu-tuh-kan de-pan ra-sa-kan me-ne-mu-kan me-nga-sih-i bah-kan di-co-cok-kan me-nim-bul-kan}
\begin{document}
\maketitle
%\vspace{-2cm}
