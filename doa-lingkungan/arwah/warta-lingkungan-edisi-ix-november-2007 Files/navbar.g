...
<div id="flagi" style="position: absolute; display: none; left: 405px;" onmouseover="showDrop()" onmouseout="hideDrop();">Beritahu Blogger mengenai  <a href="http://help.blogger.com/bin/answer.py?answer=42517" target="_blank">konten yang dilarang</a> pada halaman ini.</div>
<div id="unflagi" style="position: absolute; display: none;" onmouseover="showDrop()" onmouseout="hideDrop()">Anda menandai blog ini sebagai memiliki  <a href="http://help.blogger.com/bin/answer.py?answer=42517" target="_blank">konten yang dilarang</a>.</div>
...
<a id="b-share-this" class="b-link" tabindex="5" onclick='window.open("/share-post-menu.g?blogID\x3d4945395614455932456\x26postID\x3d6729956384050625635", "sharepopup", "width=250, height=260, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no"); return false;'>Berbagi</a>
<script type="text/javascript">
