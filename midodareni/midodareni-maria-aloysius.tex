\documentclass[a5paper,headsepline,titlepage,11pt,nnormalheadings]{scrartcl}
...
\newcommand{\BL}[1]{\begin{itemize} \item[Luy:] #1 \end{itemize}}
\newcommand{\BW}[1]{\begin{itemize} \item[Yuli:] #1 \end{itemize}}
\newcommand{\BMP}[1]{\begin{itemize} \item[J+Y:] #1 \end{itemize}}
...
%lagu-lagu
\newcommand{\lagupembuka}{Keluarga Sejati }
...
\title{IBADAT TIRAKATAN MENJELANG PERNIKAHAN (MIDODARENI)\vspace{2cm}}
\author{ 
...
\BP{Rahmat Tuhan kita Yesus Kristus, cinta kasih Allah, dan persekutuan Roh Kudus beserta kita}
\BU{Sekarang dan selama-lamanya}

\subjudul{Pengantar}
\BP{Bapak, Ibu, dan Saudara-saudara, pada malam ini, malam menjelang pernikahan saudara \camantra dan \camantri ini, yang menurut adat Jawa, para bidadari turun dari kahyangan untuk memberi berkat, maka dinamakan \emph{midodareni}. Kita sebagai umat Katolik mengadopsi upacara ini dengan memohon agar Roh Kudus turun atas calon mempelai dan keluarganya. Kita memohon berkat dari Tuhan, 
agar calon mempelai dipenuhi oleh rahmat/karunia Allah agar dapat berfungsi sesuai dengan yang dikehendaki oleh Allah. }

\subjudul{Tobat}
\BP{Marilah kita hening sejenak untuk mempersiapkan diri dalam perayaan syukur ini sambil menyadari bahwa kita sering melupakan kebaikan Tuhan dan enggan mewartakan dan mewujudkan kebaikan tersebut melalui pikiran, perkataan, dan perbuatan kita.}
...
\BP{Semoga Allah Yang Maha Kuasa mengasihi kita, mengampuni dosa kita dan menghantar kita ke hidup yang kekal.}
