...
\usepackage[papersize={165mm,215mm},twoside,bindingoffset=0.5cm,hmargin={2cm,2cm},				vmargin={2cm,2cm},footskip=1.1cm,driver=dvipdfm]{geometry}
...
\thispagestyle{empty}
%\maketitle
%\sbox\IBox{\includegraphics[scale=0.4]{Saint-Peter-Apostle-e.eps}}
...
%%% TEXEXPAND: INCLUDED FILE MARKER ./pengurus.tex
\section{Pengurus}
\begin{center}
...
&:& M. Dwi Suryanto\\
\end{tabular}
%%% TEXEXPAND: END FILE ./pengurus.tex
%%% TEXEXPAND: INCLUDED FILE MARKER ./data-umat.tex
\newpage
\section{Data Umat}
\begin{center}
...
\end{tabular}
\normalsize%%% TEXEXPAND: END FILE ./data-umat.tex
%%% TEXEXPAND: INCLUDED FILE MARKER ./jadwal-tugas.tex
\makeatletter
...
\end{enumerate}
\normalsize%%% TEXEXPAND: END FILE ./jadwal-tugas.tex
%%% TEXEXPAND: INCLUDED FILE MARKER ./pola-ibadat-lingkungan.tex
\newpage
...
\end{description}%%% TEXEXPAND: END FILE ./pola-ibadat-lingkungan.tex
%%% TEXEXPAND: INCLUDED FILE MARKER ./tata-cara-ujub.tex
...
{\it {\bf Catatan:} Segala kegiatan doa/misa pribadi yang dipersiapkan dan dilaksanakan sendiri, dengan melibatkan banyak umat, wajib dilaporkan kepada ketua lingkungan untuk diteruskan ke paroki.}%%% TEXEXPAND: END FILE ./tata-cara-ujub.tex
%\input{jaringan-sms}
%\input{pangrukti-laya}
\section*{\large DOA-DOA}
%%% TEXEXPAND: INCLUDED FILE MARKER ./doa-angelus.tex
\section{DOA ANGELUS}
...
\end{description}%%% TEXEXPAND: END FILE ./doa-angelus.tex
\small
%%% TEXEXPAND: INCLUDED FILE MARKER ./doa-masa-advent.tex
...
%%% TEXEXPAND: END FILE ./doa-masa-advent.tex
\normalsize
%%% TEXEXPAND: INCLUDED FILE MARKER ./doa-novena-roh-kudus.tex
...
Aku Percaya ...\\
Bapa Kami ...\\
Salam Maria ...}    %%% TEXEXPAND: END FILE ./doa-novena-roh-kudus.tex
%%% TEXEXPAND: INCLUDED FILE MARKER ./mudika.tex
\newpage
\begin{center}
...
\end{tabular}
\normalsize%%% TEXEXPAND: END FILE ./mudika.tex
